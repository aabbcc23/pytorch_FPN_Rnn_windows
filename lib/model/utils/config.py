...
#if active large_image detect
__C.TRAIN.ACTIVE_LARGE = True

# Max pixel size of the longest side of a scaled input TEST image
__C.TRAIN.TEST_IMAGE_SCALE = (2592,)

# Max pixel size of the longest side of a scaled input TEST image
__C.TRAIN.TEST_IMAGE_MAX_SIZE = 4608
