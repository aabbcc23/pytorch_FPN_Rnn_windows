...
from lib.model.rpn.generate_anchors import generate_anchors, generate_anchors_all_pyramids
...
class _ProposalLayer_FPN(nn.Module):
    ...
    def forward(self, input):
        ...
        for i in range(batch_size):
            ...
            #print(cfg.CUDA)
            keep_idx_i = nms(torch.cat((proposals_single, scores_single), 1), nms_thresh,cfg.CUDA)
